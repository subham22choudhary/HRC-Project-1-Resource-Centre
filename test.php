...
<section class="first-fold">
        ...
        <div class="row mt-3">
            <div class="col-lg-6 col-sm-12 col-md-7 animated fadeInLeft">
                <h2 class="global-grey">Upcoming Webinars</h2>
                <div class="item">
                    <div class="row pb-4">
                        <div class="col-md-3">
                            <img class="justify-content-sm-center img-fluid" src="https://cdn-resources.highradius.com/resources/wp-content/uploads/2022/05/Receviables-Townhall-Logo.png" alt="webinar-logo" width="100%">
                        ...
                        <div class="col-md-7 upcoming-card">
                            <h3>Decoding AI for Accounts Receivables Automation</h3>
                    ...
                    <div class="row pb-4">
                        <div class="col-md-3">
                            <img src="https://cdn-resources.highradius.com/resources/wp-content/uploads/2022/06/CFO-circle-LOGO.svg.gzip" alt="webinar-logo" width="80%">
                            <p class="text-center mt-3 mb-md-0 mb-2">
                                <span class="date">16 JUNE 2022</span>
                                <span class="time">10:30 AM CT</span>
                            </p>
                        </div>
                        <div class="col-md-7 upcoming-card">
                            <h3>How should the CFOs office overcome supply chain disruption</h3>
                            <div class="upcoming">Upcoming</div>
                            <a class="btn button" href="#">REGISTER NOW</a>
                        </div>
                    </div>
...
<div class="button-group filter-button-group " >
  ...
  <button data-filter=".webinars" class="btn-2">Webinar</button>
</div>
...
<section class=" third-fold section">
        <div class="container">
            ...
            <div class="row d-flex justify-content-center"><button type="button"
                    class="btn-1 ">Sign up for FAN</button></div>
        </div>
    </section>
